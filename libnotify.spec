...
Source0  : https://download.gnome.org/sources/libnotify/0.7/libnotify-0.7.12.tar.xz
...
%prep
%setup -q -n libnotify-0.7.12
cd %{_builddir}/libnotify-0.7.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651807049
...
cp %{_builddir}/libnotify-0.7.12/COPYING %{buildroot}/usr/share/package-licenses/libnotify/e60c2e780886f95df9c9ee36992b8edabec00bcc
