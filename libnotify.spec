...
Source0  : https://download.gnome.org/sources/libnotify/0.8/libnotify-0.8.3.tar.xz
...
%prep
%setup -q -n libnotify-0.8.3
cd %{_builddir}/libnotify-0.8.3
pushd ..
cp -a libnotify-0.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697068495
